...
${OBJECTDIR}/BarEvent.o: BarEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BarEvent.o BarEvent.cpp
...
${OBJECTDIR}/FillEvent.o: FillEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FillEvent.o FillEvent.cpp
...
${OBJECTDIR}/OrderEvent.o: OrderEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OrderEvent.o OrderEvent.cpp

${OBJECTDIR}/SignalEvent.o: SignalEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SignalEvent.o SignalEvent.cpp

${OBJECTDIR}/TickEvent.o: TickEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TickEvent.o TickEvent.cpp
...
${TESTDIR}/BarEventTest.o: BarEventTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/BarEventTest.o BarEventTest.cpp


${TESTDIR}/tests/EventTest.o: tests/EventTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/EventTest.o tests/EventTest.cpp
...
${OBJECTDIR}/BarEvent_nomain.o: ${OBJECTDIR}/BarEvent.o BarEvent.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BarEvent_nomain.o BarEvent.cpp;\
	else  \
...
${OBJECTDIR}/Event_nomain.o: ${OBJECTDIR}/Event.o Event.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Event_nomain.o Event.cpp;\
	else  \
...
${OBJECTDIR}/FillEvent_nomain.o: ${OBJECTDIR}/FillEvent.o FillEvent.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FillEvent_nomain.o FillEvent.cpp;\
	else  \
...
${OBJECTDIR}/OrderEvent_nomain.o: ${OBJECTDIR}/OrderEvent.o OrderEvent.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OrderEvent_nomain.o OrderEvent.cpp;\
	else  \
...
${OBJECTDIR}/SignalEvent_nomain.o: ${OBJECTDIR}/SignalEvent.o SignalEvent.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SignalEvent_nomain.o SignalEvent.cpp;\
	else  \
...
${OBJECTDIR}/TickEvent_nomain.o: ${OBJECTDIR}/TickEvent.o TickEvent.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TickEvent_nomain.o TickEvent.cpp;\
	else  \
