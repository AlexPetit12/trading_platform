...
${TESTDIR}/FillEventTest.o: FillEventTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/FillEventTest.o FillEventTest.cpp


${TESTDIR}/OrderEventTest.o: OrderEventTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/OrderEventTest.o OrderEventTest.cpp


${TESTDIR}/SignalEventTest.o: SignalEventTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/SignalEventTest.o SignalEventTest.cpp


${TESTDIR}/TickEventTest.o: TickEventTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/TickEventTest.o TickEventTest.cpp
